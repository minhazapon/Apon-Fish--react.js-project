...
const SignUp = () => {
    ...
    return (
        ...
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl  bg-blue-500 text-gray-100">
            ...
            <form  onSubmit={handleUp}   className="space-y-6">
                ...
                <input className="block w-full btn p-3 text-center rounded-sm text-gray-900 bg-violet-400" type="submit" value="SignUp" />
