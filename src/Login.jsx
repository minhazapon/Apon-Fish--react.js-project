...
const Login = () => {
    ...
    const {SignIn, GUP} = useContext(fireContext)
    ...
    return (
        ...
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl  bg-blue-600 text-gray-100">
            ...
            <form  onSubmit={handleLog} className="space-y-6">
                ...
                <input className="block btn w-full p-3 text-center rounded-sm text-gray-900 bg-violet-400" type="submit" value="Sign In" />
